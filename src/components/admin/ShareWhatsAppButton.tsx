    ...
    <>
      <button
        ...
        style={{
          ...
          background: loading ? "rgba(255,255,255,0.04)" : "rgba(37,211,102,0.1)",
          color: loading ? "rgba(237,232,222,0.35)" : "#25D366",
          border: "none",
          borderRadius: 7,
          fontWeight: 500,
          fontSize: 12,
        ...
        {loading ? (
          <>
            <span style={{
              ...
              border: "1.5px solid rgba(237,232,222,0.2)",
              borderTopColor: "rgba(237,232,222,0.6)",
              borderRadius: "50%",
          ...
          <>
            <WhatsAppIcon />
            <span className="inv-btn-label">WhatsApp</span>
          </>
        )}
      </button>
